...
export const translations = {
  en: {
    ...
    hero: {
      ...
      greeting: "This is",
      name: "Talkao",
      tagline: "AI-powered translation. 125+ languages.",
      achievements: [
        { headline: "6.7× ROAS", sub: "ad spend efficiency" },
        { headline: "€174K ARR", sub: "annual recurring revenue" },
        { headline: "170K MAU", sub: "Voice Translator users" },
        { headline: "125+ languages", sub: "voice · text · image" },
        { headline: "Accelerator '26", sub: "Google Play cohort" },
        { headline: "10+ shipped", sub: "components in 4 weeks" },
      ],
      ctaTalk: "Talk to me",
      ctaExplore: "See the ecosystem",
      scrollDown: "Scroll down",
    },
    bento: {
      eyebrow: "The ecosystem · at a glance",
      headingA: "Four brands.",
      headingB: "One operator.",
      rightNote:
        "Translation, document productivity, AI consulting, and a parking marketplace — four ventures, one operator.",
      talkao: {
        tagA: "Translation suite",
        tagB: "Accelerator 2026",
        title: "Talkao",
        desc: "AI-powered translation across 125+ languages. Voice, image and AR — three apps under one brand.",
        apps: {
          voiceTranslator: {
            label: "Voice Translator",
            tag: "Flagship",
            value: "170K MAU · 125+ languages",
          },
          cameraTranslator: {
            label: "Camera Translator",
            value: "image · AI",
          },
          arTranslator: {
            label: "AR Translator",
            value: "live AR · 100+ langs",
          },
        },
  ...
  es: {
    ...
    hero: {
      ...
      greeting: "Esto es",
      name: "Talkao",
      tagline: "Traducción con IA. Más de 125 idiomas.",
      achievements: [
        { headline: "6.7× ROAS", sub: "eficiencia de gasto" },
        { headline: "€174K ARR", sub: "ingresos anuales recurrentes" },
        { headline: "170K MAU", sub: "usuarios de Voice Translator" },
        { headline: "125+ idiomas", sub: "voz · texto · imagen" },
        { headline: "Accelerator '26", sub: "cohorte Google Play" },
        { headline: "10+ enviados", sub: "componentes en 4 semanas" },
      ],
      ctaTalk: "Hablemos",
      ctaExplore: "Ver el ecosistema",
      scrollDown: "Desplázate hacia abajo",
    },
    bento: {
      eyebrow: "El ecosistema · de un vistazo",
      headingA: "Cuatro marcas.",
      headingB: "Un operador.",
      rightNote:
        "Traducción, productividad documental, consultoría IA y marketplace de parking — cuatro apuestas, un operador.",
      talkao: {
        tagA: "Suite de traducción",
        tagB: "Accelerator 2026",
        title: "Talkao",
        desc: "Traducción con IA en más de 125 idiomas. Voz, imagen y AR — tres apps bajo una misma marca.",
        apps: {
          voiceTranslator: {
            label: "Voice Translator",
            tag: "Producto estrella",
            value: "170K MAU · 125+ idiomas",
          },
          cameraTranslator: {
            label: "Camera Translator",
            value: "imagen · IA",
